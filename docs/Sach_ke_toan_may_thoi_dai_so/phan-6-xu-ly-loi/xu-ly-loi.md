...
## 6.2. Khi nhập các nghiệp vụ phát sinh
Các lỗi thường gặp:  
...
## 6.4. Khi thực hiện kết chuyển tự động
Các lỗi thường gặp:  
...
## 6.5. Khi kết xuất dữ liệu sang phần mềm HTKK
Các lỗi thường gặp:  
...
## 6.6. Hướng dẫn kiểm tra và xử lý dữ liệu kế toán
